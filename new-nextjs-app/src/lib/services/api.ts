...
export const api = {
        ...
        properties: {
                ...
                searchSuggestions: (query: string) => unwrap<any>(http.get("/properties/search-suggestions", { params: { query } })),
        },
        admin: {
                ...
                contactStats: () => unwrap<any>(http.get("/admin/contacts/stats")),
                getInquiry: (id: string) => unwrap<any>(http.get(`/admin/inquiries/${id}`)),
                updateUser: (userId: string, payload: any) => unwrap<any>(http.put(`/admin/users/${userId}`, payload)),
                updateUserStatus: (userId: string, payload: any) => unwrap<any>(http.patch(`/admin/users/${userId}/status`, payload)),
                ...
                settings: () => unwrap<any>(http.get("/admin/settings")),
                updateSettings: (payload: any) => unwrap<any>(http.put("/admin/settings", payload)),
                backup: () => unwrap<any>(http.post("/admin/backup")),
                restore: (backupId: string) => unwrap<any>(http.post(`/admin/restore/${backupId}`)),
                reports: (params?: Record<string, any>) => unwrap<any>(http.get("/admin/reports", { params })),
                exportReport: (params?: Record<string, any>) => unwrap<any>(http.get("/admin/reports/export", { params })),
                emailReport: (payload: any) => unwrap<any>(http.post("/admin/reports/email", payload)),
                agents: (params?: Record<string, any>) => unwrap<PaginatedResult<any>>(http.get("/admin/agents", { params })),
                media: (params?: Record<string, any>) => unwrap<any[]>(http.get("/admin/media", { params })),
                uploadMedia: (formData: FormData, config?: any) => unwrap<any>(http.post("/admin/media/upload", formData, config)),
                updateMedia: (id: string, payload: any) => unwrap<any>(http.put(`/admin/media/${id}`, payload)),
                deleteMedia: (id: string) => unwrap<any>(http.delete(`/admin/media/${id}`)),
        },
        agent: {
                ...
                properties: (params?: Record<string, any>) => unwrap<PaginatedResult<any>>(http.get(`/properties/agent/${params?.agentId || ''}`, { params })),
        ...
        subscriptions: {
                ...
                getMySubscription: () => unwrap<any>(http.get("/subscriptions/my-subscription")),
                getBillingHistory: () => unwrap<any>(http.get("/subscriptions/billing-history")),
                getUpcomingBilling: () => unwrap<any>(http.get("/subscriptions/upcoming-billing")),
                ...
                downloadInvoice: (subscriptionId: string) =>
                        unwrap<any>(http.get(`/subscriptions/invoice/${subscriptionId}/download`, { responseType: 'blob' })),
        },
        developers: {
        ...
        search: {
                suggestions: (query: string) => unwrap<any>(http.get("/properties/search-suggestions", { params: { query } })),
        },
        contacts: {
