...
//             {/* White background frame - Adjusted left border position */}
//             <div className="absolute w-full h-full ml-2 sm:ml-4 mt-5 sm:mt-6 rounded-t-2xl sm:rounded-t-3xl border-r-2 border-t-2 border-l-2 border-b-2 border-white bg-white"></div>
            
//             {/* Image container - Adjusted left border position */}
//             <motion.div
//               initial={{ opacity: 0, y: 50 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.6 }}
//               className="rounded-t-2xl sm:rounded-t-3xl overflow-hidden border-r-2 border-t-2 border-l-2 border-b-2 border-white relative z-10"
//             >
//               <img 
//                 src="/building_4.jpg" 
